...
Originally generated by 'django-admin startproject' with Django 1.10.2.
This settings module is maintained for modern Django compatibility.
...
STATICFILES_DIRS = [
    # Add source directories here, but do not include STATIC_ROOT.
]
