    ...
    def __init__(self, *args, **kwargs):
        ...
        for i, q in enumerate(tags):
            ...
            if q.type == q.TEXT:
                ...
                self.fields['%s' % q.id] = forms.IntegerField(
                    label=str(q),
                    required=iform_tag.required,
                ...
                self.fields['%s' % q.id] = forms.DecimalField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled=iform_tag.read_only,
                ...
                self.fields['%s' % q.id] = forms.BooleanField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled = iform_tag.read_only,
                    initial=iform_tag.default_value,
                ...
                self.fields['%s' % q.id] = forms.DateField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled=iform_tag.read_only,
                    initial=iform_tag.default_value,
                ...
                self.fields['%s' % q.id] = forms.TimeField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled=iform_tag.read_only,
                    initial=iform_tag.default_value,
                ...
                self.fields['%s' % q.id] = forms.DateTimeField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled=iform_tag.read_only,
                    initial=iform_tag.default_value,
            ...
            # elif q.type == q.MONEY:
                ...
                self.fields['%s' % q.id] = forms.ImageField(
                    label=str(q),
                    required=iform_tag.required,
                    disabled=iform_tag.read_only,
                    initial=iform_tag.default_value,
